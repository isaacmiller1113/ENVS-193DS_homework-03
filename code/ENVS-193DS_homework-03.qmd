...
### Visualization 2. Linear regression
...
My affective visualization would take the form of a digitally drawn iPad illustration called “The Swamped Coastline.” The 42 days of my data would be represented as a shoreline, where rising water levels symbolize the amount of time spent on school days and schoolwork. As the tide rises, murky water covers icons representing activities like surfing, running, gym workouts, scuba diving, or skateboarding, illustrating how school responsibilities can overwhelm my schedule. On days with less school work, the tide is lower and these icons are clearly visible on the sand, representing more balance in my daily life. This visualization focuses on communicating the feeling of being flooded by school demands, which aligns with the goal of affective visualizations to emphasize emotion and creativity rather than strict analytical precision.
